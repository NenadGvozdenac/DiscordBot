...
//                  {
//                      Member member = ((net.dv8tion.jda.api.entities.Guild) guild).getMember(user);  //We get the member object for each mentioned user to kick them!
//
...
//
//          Member member = (Member) event.getMember(); //This Member that sent the message. Contains Guild specific information about the User!
