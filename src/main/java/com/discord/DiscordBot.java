...
public class DiscordBot {
	...
	static {
		globalneKomande = new Komanda[] {
			...
			new Komanda("algebra", "Komanda za odredjivanje ocene iz algebre.", false, new Opcija(OptionType.NUMBER, "bodovi1", "Unesite broj bodova prvog dela.", true), new Opcija(OptionType.NUMBER, "bodovi2", "Unesite broj bodova drugog dela.", true), new Opcija(OptionType.NUMBER, "bodovi3", "Unesite broj bodova treceg dela.", true), new Opcija(OptionType.NUMBER, "bodovi4", "Unesite broj bodova cetvrtog dela.", true)),
